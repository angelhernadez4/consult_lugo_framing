...
/**
 * Determina el género gramatial de una palabra basándose en reglas heurísticas y listas de excepciones.
 * @param text - La palabra o frase a analizar.
 * @returns `Gender.MALE`, `Gender.FEMALE` o `undefined si no hay texto válido.
 * */
export const getGender = (text: string) => {
